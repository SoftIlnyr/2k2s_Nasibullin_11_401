    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="/talons/${talon.id}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" style="width: 100%;" name="book">
                                    <option selected="selected">${talon.book.id} - ${talon.book.title} </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" style="width: 100%;" name="library">
                                    <option selected="selected">${talon.library.id} - ${talon.library.name}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" style="width: 100%;" name="status">
                                    <option selected="selected">${talon.status}</option>
