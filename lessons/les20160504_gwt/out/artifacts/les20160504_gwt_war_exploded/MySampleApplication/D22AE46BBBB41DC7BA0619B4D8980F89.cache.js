...
var $strongName = 'D22AE46BBBB41DC7BA0619B4D8980F89';
var $gwt = {};
...
function com_google_gwt_lang_com_100046mySampleApplication_100046MySampleApplication_1_1EntryMethodHolder_init__V(){
  ...
  (com_google_gwt_user_client_DOM_$clinit__V() , com_mySampleApplication_client_MySampleApplication_$onModuleLoad__Lcom_mySampleApplication_client_MySampleApplication_2V_formPanel_0.com_google_gwt_user_client_ui_UIObject_element).style['height'] = '50px';
  com_mySampleApplication_client_MySampleApplication_$onModuleLoad__Lcom_mySampleApplication_client_MySampleApplication_2V_formPanel_0.com_google_gwt_user_client_ui_UIObject_element.style['width'] = '100px';
...
function com_google_gwt_user_client_ui_FileUpload_FileUpload__V(){
  ...
  com_google_gwt_dom_client_Element_$setClassName__Lcom_google_gwt_dom_client_Element_2Ljava_lang_String_2V((com_google_gwt_user_client_DOM_$clinit__V() , this.com_google_gwt_user_client_ui_UIObject_element), 'gwt-FileUpload');
}
...
function com_google_gwt_user_client_ui_FormPanel_$setTarget__Lcom_google_gwt_user_client_ui_FormPanel_2Ljava_lang_String_2V(this$static, target){
  com_google_gwt_dom_client_FormElement_$setTarget__Lcom_google_gwt_dom_client_FormElement_2Ljava_lang_String_2V((com_google_gwt_user_client_DOM_$clinit__V() , this$static.com_google_gwt_user_client_ui_UIObject_element), target);
}
...
function com_google_gwt_user_client_ui_FormPanel_FormPanel__Lcom_google_gwt_dom_client_Element_2ZV(element){
  ...
  this.com_google_gwt_user_client_ui_Widget_eventsToSink == -1?com_google_gwt_user_client_impl_DOMImplStandard_$sinkEvents__Lcom_google_gwt_user_client_impl_DOMImplStandard_2Lcom_google_gwt_dom_client_Element_2IV(this.com_google_gwt_user_client_ui_UIObject_element, 32768 | (this.com_google_gwt_user_client_ui_UIObject_element.__eventBits || 0)):(this.com_google_gwt_user_client_ui_Widget_eventsToSink |= 32768);
}
...
_.onAttach__V = function com_google_gwt_user_client_ui_FormPanel_onAttach__V(){
  ...
  if (this.com_google_gwt_user_client_ui_FormPanel_frameName != null) {
    com_google_gwt_user_client_ui_FormPanel_$createFrame__Lcom_google_gwt_user_client_ui_FormPanel_2V_dummy_0 = $doc.createElement('div');
...
function com_google_gwt_user_client_ui_impl_FormPanelImpl_$hookEvents__Lcom_google_gwt_user_client_ui_impl_FormPanelImpl_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_user_client_ui_impl_FormPanelImplHost_2V(iframe, form_0, listener){
...
function com_google_gwt_user_client_ui_impl_FormPanelImpl_$unhookEvents__Lcom_google_gwt_user_client_ui_impl_FormPanelImpl_2Lcom_google_gwt_dom_client_Element_2Lcom_google_gwt_dom_client_Element_2V(iframe, form_0){
