...
public class Server {
    ...
    protected void go() throws IOException, ClassNotFoundException, InterruptedException {
    ...
    public PlayersThread getThread() {
        return thread;
    }

    public void setThread(PlayersThread thread) {
        this.thread = thread;
    }
}
