...
public class DestroyerTest {
    ...
    public static void BeforeClass() {
        destroyer = new Destroyer("Number 1", 1000, 60, new ArrayList<>());
    }
    ...
    public void testAddTorpedoMethodShoildWorkCorrect() throws Exception {
        Destroyer d1 = new Destroyer("A", 5, 5, new ArrayList<>());
    ...
    public void testScoutPointShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("main.Destroyer moves to the point 5:6", outContent.toString());
    }
    ...
    public void testBoardingShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("main.Destroyer attacks tagged ship", outContent.toString());
    }

    @Test
    public void testSmokeShouldWorkCorrect() throws Exception {
        destroyer.smoke();
        Assert.assertEquals("main.Destroyer makes a big smoke veil. No main.Warship can see at the 5 km distance!", outContent.toString());
    ...
    public void testLaunchTorpedoAngleShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("Destoyer picked a torpedo\n" +
                "main.Destroyer launched all torpedoes to the angle 5\n" +
    ...
    public void testLaunchTorpedoTargetShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("Destoyer picked a torpedo\n" +
                "main.Destroyer launched all torpedoes to the target \n" +
    ...
    public void testMoveTo() throws Exception {
        ...
        Assert.assertEquals("main.Destroyer moves to the 1:8", outContent.toString());
    }
