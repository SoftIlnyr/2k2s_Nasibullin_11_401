...
public class Nautilus implements Submarine {
    ...
    public void addMine(Mine mine) {
        mines.add(mine);
        System.out.println("main.Nautilus picks a mine");
    }

    @Override
    public void diveDepth(int x) {
        System.out.println("main.Nautilus dives to " + x);
    }

    @Override
    public void dropMineAndMoveTo(int x, int y) {
        System.out.println("main.Nautilus drops a mine and goes to " + x + ":" + y);
    }

    @Override
    public void moveTo(int x, int y) {
        System.out.println("main.Nautilus moves to " + x + ":" + y);

    }

    @Override
    public void attackShip(Warship warship) {
        System.out.println("main.Nautilus can't attack a ship!");
    }
