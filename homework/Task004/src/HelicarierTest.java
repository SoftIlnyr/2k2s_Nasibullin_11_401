...
public class HelicarierTest {
    ...
    public void testPlaneToVentureShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("Helicarier sends a plane to the point 1:5", outContent.toString());
    }
    ...
    public void testPlaneToAttackShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("Helicarier sends all planes to attack warship", outContent.toString());
    }

    @Test
    public void testMoveToShouldWorkCorrect() throws Exception {
        helicarier.moveTo(4, 2);
        Assert.assertEquals("Helicarier moves to point 4:2", outContent.toString());
    }
