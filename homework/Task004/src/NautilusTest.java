...
public class NautilusTest {
    ...
    public void testDiveDepthShouldWorkCorrect() throws Exception {
        ...
        Assert.assertEquals("Nautilus dives to 72", outContent.toString());
    ...
    public void testDropMineAndMoveTo() throws Exception {
        ...
        Assert.assertEquals("Nautilus drops a mine and goes to 1:5", outContent.toString());
    }

    @Test
    public void testMoveToShouldWorkCorrect() throws Exception {
        nautilus.moveTo(1, 5);
        Assert.assertEquals("Nautilus moves to 1:5", outContent.toString());
    }
    ...
    public void testAttackShip() throws Exception {
        ...
        Assert.assertEquals("Nautilus can't attack a ship!", outContent.toString());
    }

    @Test
    public void testAttackPoint() throws Exception {
        nautilus.attackPoint(5, 7);
        Assert.assertEquals("Nautilus moves to 5:7\n" +
                "Nautilus drops a mine and goes to -5:-7", outContent.toString());
